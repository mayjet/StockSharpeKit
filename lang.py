...
_L: dict[str, dict[str, str]] = {
    "JP": {
        ...
        "desc_risk_free_rate":  "シャープレシオ計算に使う金利（例: 0.001 = 0.1%）",
        "label_min_weight":     "最小投資比率",
        "desc_min_weight":      "各銘柄への最小割り当て比率（0.0 = 制約なし）",
    ...
    "EN": {
        ...
        "desc_risk_free_rate":  "Rate used for Sharpe ratio calculation (e.g. 0.001 = 0.1%)",
        "label_min_weight":     "Min Weight",
        "desc_min_weight":      "Minimum allocation per asset (0.0 = no constraint)",
